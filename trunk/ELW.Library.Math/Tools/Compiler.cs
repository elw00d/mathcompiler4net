    ...
    public sealed class Compiler {
        ...
        private sealed class OperationsStack {
            ...
            public void PushConstant(double constant) {
                ...
                isLastOperationBinaryOrHavingMoreOperands = false;
            }
            ...
            private bool isLastOperationBinaryOrHavingMoreOperands = false;
            public bool IsLastOperationBinaryOrHavingMoreOperands()
            {
                return isLastOperationBinaryOrHavingMoreOperands;
                //if (this.stack.Count != 0) {
                //    OperationsStackItem item = this.stack[this.stack.Count - 1];
                //    if (item.Kind == OperationStackItemKind.Operation) {
                //        if (operationsRegistry.GetOperationByName(item.OperationName).OperandsCount >= 2) {
                //            return true;
                //        }
                //    }
                //}
            ...
            public void PushBinaryOperator(Operation operation) {
                pushOperationAccordingToAssociationAndPriority(operation,
                                                               new OperationsStackItem(OperationStackItemKind.Operation, operation.Name));
                isLastOperationBinaryOrHavingMoreOperands = true;
            }
